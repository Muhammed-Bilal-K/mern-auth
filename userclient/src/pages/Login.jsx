...
function Login() {
    ...
    const HandleSubmit = (e) => {
        ...
        axios.post('http://localhost:3000/admin/a_login', { ...userDetail }).then((result) => {
        ...
        <div>
            <div className="container">
                <div className="frame">
                    <div className="nav">
                        <ul>
                            <li className="signup-inactive"><a className="btn">Sign In </a></li>
                        </ul>
                    </div>
                    <div>
                        <form className="form-signin" onSubmit={HandleSubmit} name="form" style={{ textAlign: "center" }}>
                            ...
                            <div className='Direct_SU'>
                                ...
                                <Link to='/signup'><h5 className="direct_button">Sign Up</h5></Link>
                            </div>
                        </form>
                    </div>
                </div>
